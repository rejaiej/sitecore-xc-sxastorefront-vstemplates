namespace Customer.Commerce.XA.Storefront.Extension.Wizards
{
    ...
    public class SXAStorefrontHelixWizard : IWizard
    {
        ...
        private void AddRealHelixProject()
        {
            // get solution folder
            var solutionFolder = this._currentDTE.Solution.Projects.Cast<Project>().FirstOrDefault(p => p.Name.ToLowerInvariant().Contains(this._sitecoreConfiguration.HelixConfiguration.Layer.ToLowerInvariant()))?.Object as SolutionFolder;
            ...
            this.CleanupHelixProjectFolders();
        }

        private void CleanupHelixProjectFolders()
        {
            ...
            // delete the parent if it's there.
